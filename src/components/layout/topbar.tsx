    ...
    <GlassPanel className="sticky top-3 z-10 p-3 sm:top-4 sm:p-4">
      <div className="flex items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="flex size-11 items-center justify-center rounded-[1.2rem] border border-white/8 bg-background/70 text-muted-foreground transition-all hover:border-primary/20 hover:bg-primary/8 hover:text-foreground"
            aria-label="Notificações"
          >
            <Bell className="size-4" />
          </button>
          <div className="flex items-center gap-3 rounded-[1.2rem] border border-white/8 bg-background/72 px-3 py-2.5">
            <div className="flex size-9 items-center justify-center rounded-[0.9rem] bg-primary/15 text-sm font-semibold text-primary shadow-[0_0_22px_rgba(104,255,182,0.16)]">
              VF
            </div>
