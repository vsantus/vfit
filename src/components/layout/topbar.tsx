    ...
    <GlassPanel className="sticky top-3 z-10 p-3 sm:top-4 sm:p-4">
      <div className="flex w-full items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex w-full items-center gap-3">
          ...
          <LogoutButton
            variant="outline"
            className="ml-auto h-11 rounded-[1.1rem] border-border/70 bg-card/80 px-4 text-foreground hover:bg-secondary"
          >
          ...
          <div className="flex items-center gap-3 rounded-[1.2rem] border border-border/70 bg-card/80 px-3 py-2.5">
